...
func init() {
	...
	enemy_img81, _, _ := ebitenutil.NewImageFromFile("./art/enemy/enemy81.png")
	enemy_images[81] = enemy_img81
	enemy_img82, _, _ := ebitenutil.NewImageFromFile("./art/enemy/enemy82.png")
	enemy_images[82] = enemy_img82
	enemy_img83, _, _ := ebitenutil.NewImageFromFile("./art/enemy/enemy83.png")
	enemy_images[83] = enemy_img83
	enemy_img84, _, _ := ebitenutil.NewImageFromFile("./art/enemy/enemy84.png")
	enemy_images[84] = enemy_img84
	enemy_img85, _, _ := ebitenutil.NewImageFromFile("./art/enemy/enemy85.png")
	enemy_images[85] = enemy_img85
	enemy_img86, _, _ := ebitenutil.NewImageFromFile("./art/enemy/enemy86.png")
	enemy_images[86] = enemy_img86
	enemy_img87, _, _ := ebitenutil.NewImageFromFile("./art/enemy/enemy87.png")
	enemy_images[87] = enemy_img87
	enemy_img88, _, _ := ebitenutil.NewImageFromFile("./art/enemy/enemy88.png")
	enemy_images[88] = enemy_img88
	enemy_img89, _, _ := ebitenutil.NewImageFromFile("./art/enemy/enemy89.png")
	enemy_images[89] = enemy_img89
	enemy_img90, _, _ := ebitenutil.NewImageFromFile("./art/enemy/enemy90.png")
	enemy_images[90] = enemy_img90
